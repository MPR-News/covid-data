GET(url = "https://www.health.state.mn.us/diseases/coronavirus/stats/vbtadultaarates.csv",
...
GET(url = "https://www.health.state.mn.us/diseases/coronavirus/stats/vbtpedsaarates.csv",
	user_agent(user_agent),
	write_disk(tmp <- tempfile()))
...
GET(url = "https://www.health.state.mn.us/diseases/coronavirus/stats/vbtadultcirates.csv",
	user_agent(user_agent),
	write_disk(tmp <- tempfile()))

breakthroughs_weighted_age_adults <- read_csv(tmp) %>%
	set_names("week_start", "week", "age", 
...
GET(url = "https://www.health.state.mn.us/diseases/coronavirus/stats/vbtpedscirates.csv",
	user_agent(user_agent),
	write_disk(tmp <- tempfile()))

breakthroughs_weighted_age_kids <- read_csv(tmp) %>%
	set_names("week_start", "week", "age", 
