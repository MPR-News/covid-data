...
```{r data_by_year}
source(here("R/gfx/positivity-years.R"))
source(here("R/gfx/positivity-years-sample.R"))
source(here("R/gfx/cases-years.R"))
source(here("R/gfx/cases-years-sample.R"))
source(here("R/gfx/tests-years-sample.R"))
...
```{r}
source(here("R/gfx/change-14day-sample.R"))
```
